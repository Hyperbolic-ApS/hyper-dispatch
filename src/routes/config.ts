...
<div class="form-card">
  <form method="POST" action="${action}">
    ...
    <div class="field">
      ...
      <div class="hint">Base domain (no scheme) for Coolify per-PR previews. Resulting URLs look like <code>https://123.preview.example.com</code>. Leave blank to disable preview links.</div>
    </div>
    <div class="field">
